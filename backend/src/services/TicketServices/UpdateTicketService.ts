...
interface TicketData {
  ...
  lastMessage?: string;
  dealValue?: number; // GARANTIR QUE ESTÁ AQUI
}
...
const UpdateTicketService = async ({
  ...
  try {
    ...
    // DESESTRUTURAR dealValue
    let { queueId, userId, whatsappId, lastMessage = null, dealValue } = ticketData; 
  ...
  ticketTraking.userId = ticket.userId;
    ...
    // CORREÇÃO CRÍTICA: Passar o dealValue para o update
    await ticket.update({
      status,
      queueId,
      userId,
