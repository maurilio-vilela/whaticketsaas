...
import { DeleteOutline, Edit, AttachFile, Image, Mic, Audiotrack } from "@material-ui/icons";
...
const Quickemessages = () => {
    ...
    // Helper para ícone de mídia
    const getMediaIcon = (mediaName) => {
        if (!mediaName) return null;
        const ext = mediaName.split(".").pop().toLowerCase();
        if (["jpg", "jpeg", "png", "gif"].includes(ext)) return <Image color="primary" />;
        if (["mp3", "ogg", "wav"].includes(ext)) return <Mic color="secondary" />;
                ...
                <Table size="small">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center">{i18n.t("quickMessages.table.status")}</TableCell>
                                ...
                                <TableRow key={quickemessage.id}>
                                    ...
                                    <TableCell align="center">
                                        {quickemessage.mediaPath ? (
                                            <Tooltip title={quickemessage.mediaName || "Anexo"}>
                                                {getMediaIcon(quickemessage.mediaPath)}
                                            </Tooltip>
                                        ) : (
                                            "-"
                                        )}
                                    ...
                                    <TableCell align="center">
                                        {quickemessage.geral && (
                                            <Tooltip title="Visível para todos">
